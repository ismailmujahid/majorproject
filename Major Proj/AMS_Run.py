...
window = tk.Tk()
window.title("FAS-Face Recognition Based Attendance System")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/system-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\system-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('C:\system-main\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                harcascadePath = "C:\system-main\haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv("C:\system-main\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\system-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'admin':
            if password == 'admin':
                ...
                cs = 'C:/system-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    global detector
    detector = cv2.CascadeClassifier("C:\system-main\haarcascade_frontalface_default.xml")
    try:
        global faces, Id
    ...
    try:
        recognizer.save("C:\system-main\TrainingImageLabel\Trainner.yml")
    except Exception as e:
